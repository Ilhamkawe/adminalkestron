<div class="container-fluid mt--6">
        ...
        <div class="card">
          <div class="card-header border-0">
            <div class="row align-items-center">
              <div class="col">
                <h3 class="mb-0">Input Data Satuan</h3>
              </div>
            </div>
          </div>
              ...
              <tbody>
                <tr>
                    <form wire:submit.prevent="storeSatuan">
                        <td>*</td>
                        <td>
                          <input type="text" wire:model="satuan" class="form-control">
                        </td>
            ...
            <table class="table align-items-center table-flush">
              ...
              <tbody>
                ...
                <tr>
                    <td>*</td>
                    <td>{{ $s->nama }}</td>
                    <td><button class="btn btn-danger" wire:click="SelectItem('Hapus',{{ $s->id }})">Hapus</button></td>
                </tr>
                @empty
                <tr>
              ...
              {{ $satuans->links('pagination::bootstrap-4') }}
            </table>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalDeleteSatuan" tabindex="-1" role="dialog" aria-labelledby="modalFormPending" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalFormPending">Hapus Satuan</h5>
